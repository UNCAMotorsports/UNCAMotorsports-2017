...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x480000D4u + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x480000DCu + CYAPP_ECC_OFFSET))

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x480000E8u + CYAPP_ECC_OFFSET))

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)(0x480000F0u + CYAPP_ECC_OFFSET))
