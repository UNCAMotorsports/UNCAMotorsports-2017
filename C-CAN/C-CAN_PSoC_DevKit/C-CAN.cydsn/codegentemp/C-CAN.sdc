...
# Date: Mon, 12 Jun 2017 22:59:09 GMT
#set_units -time ns
create_clock -name {Clock_4(routed)} -period 55.555555555555543 -waveform {0 27.7777777777778} [list [get_pins {ClockBlock/dclk_0}]]
create_clock -name {timer_clock(routed)} -period 1000 -waveform {0 500} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 73 145} [list [get_pins {ClockBlock/dclk_glb_1}]]
...
# Project: C:\Users\Patrick\Documents\GitHub\UNCAMotorsports-2017\C-CAN\C-CAN_PSoC_DevKit\C-CAN.cydsn\C-CAN.cyprj
# Date: Mon, 12 Jun 2017 22:59:03 GMT
