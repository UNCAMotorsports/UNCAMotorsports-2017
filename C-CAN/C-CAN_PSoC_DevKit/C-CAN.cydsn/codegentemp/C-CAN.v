...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=18000000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=1000000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("8fbc7237-5877-481a-89b5-425e8138e74b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Encoder_Left, CY_INSTANCE_SHORT_NAME=Encoder_Left, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=Encoder_Left, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=leftEncTimer, CY_INSTANCE_SHORT_NAME=leftEncTimer, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=leftEncTimer, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Encoder_Right, CY_INSTANCE_SHORT_NAME=Encoder_Right, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=Encoder_Right, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=rightEncTimer, CY_INSTANCE_SHORT_NAME=rightEncTimer, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=rightEncTimer, )
...
module top ;
    ...
    defparam AMux_1.muxin_width = 6;
    defparam AMux_1.init_mux_sel = 6'h0;
    defparam AMux_1.one_active = 1;
    defparam AMux_1.connect_mode = 0;
    
    // -- AMux AMux_1 end --

	wire [0:0] tmpOE__two_net;
	wire [0:0] tmpFB_0__two_net;
	wire [0:0] tmpIO_0__two_net;
	wire [0:0] tmpINTERRUPT_0__two_net;
	electrical [0:0] tmpSIOVREF__two_net;
	...
	cy_psoc3_pins_v1_10
		...
		two
		 (.oe(tmpOE__two_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__two_net[0:0]}),
		  .analog({Net_1329}),
		  .io({tmpIO_0__two_net[0:0]}),
		  .siovref(tmpSIOVREF__two_net),
		  .interrupt({tmpINTERRUPT_0__two_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__two_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__one_net;
	wire [0:0] tmpFB_0__one_net;
	wire [0:0] tmpIO_0__one_net;
	wire [0:0] tmpINTERRUPT_0__one_net;
	electrical [0:0] tmpSIOVREF__one_net;
	...
	cy_psoc3_pins_v1_10
		...
		one
		 (.oe(tmpOE__one_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__one_net[0:0]}),
		  .analog({Net_1120}),
		  .io({tmpIO_0__one_net[0:0]}),
		  .siovref(tmpSIOVREF__one_net),
		  .interrupt({tmpINTERRUPT_0__one_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__one_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__zero_net;
	wire [0:0] tmpFB_0__zero_net;
	wire [0:0] tmpIO_0__zero_net;
	wire [0:0] tmpINTERRUPT_0__zero_net;
	electrical [0:0] tmpSIOVREF__zero_net;
	...
	cy_psoc3_pins_v1_10
		...
		zero
		 (.oe(tmpOE__zero_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__zero_net[0:0]}),
		  .analog({Net_1328}),
		  .io({tmpIO_0__zero_net[0:0]}),
		  .siovref(tmpSIOVREF__zero_net),
		  .interrupt({tmpINTERRUPT_0__zero_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__zero_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("396a0609-6548-43a2-bb56-ff95b8f2bef1"),
		  .source_clock_id("315365C3-2E3E-4f04-84A2-BB564A173261"),
		  .divisor(0),
		  .period("83333333333333.3"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_1373));
    ...
    Counter_v3_0_2 Encoder_Left (
        ...
        .up_ndown(1'b1),
        .count(Net_911));
    defparam Encoder_Left.CaptureMode = 0;
    defparam Encoder_Left.ClockMode = 0;
    defparam Encoder_Left.CompareMode = 1;
    defparam Encoder_Left.CompareStatusEdgeSense = 1;
    defparam Encoder_Left.EnableMode = 0;
    defparam Encoder_Left.ReloadOnCapture = 0;
    defparam Encoder_Left.ReloadOnCompare = 0;
    defparam Encoder_Left.ReloadOnOverUnder = 0;
    defparam Encoder_Left.ReloadOnReset = 1;
    defparam Encoder_Left.Resolution = 16;
    defparam Encoder_Left.RunMode = 0;
    defparam Encoder_Left.UseInterrupt = 1;


	cy_clock_v1_0
		#(.id("44c7faef-3d84-40d8-b9a1-4626677b81d6"),
	...
	cy_clock_v1_0
		#(.id("eccc3d3b-18f2-4404-85ca-286cc62dc77c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    Counter_v3_0_3 leftEncTimer (
        ...
        .up_ndown(1'b1),
        .count(Net_1162));
    defparam leftEncTimer.CaptureMode = 0;
    defparam leftEncTimer.ClockMode = 0;
    defparam leftEncTimer.CompareMode = 1;
    defparam leftEncTimer.CompareStatusEdgeSense = 1;
    defparam leftEncTimer.EnableMode = 0;
    defparam leftEncTimer.ReloadOnCapture = 0;
    defparam leftEncTimer.ReloadOnCompare = 0;
    defparam leftEncTimer.ReloadOnOverUnder = 0;
    defparam leftEncTimer.ReloadOnReset = 1;
    defparam leftEncTimer.Resolution = 16;
    defparam leftEncTimer.RunMode = 0;
    defparam leftEncTimer.UseInterrupt = 1;
	...
	wire [0:0] tmpOE__Enc_L_net;
	wire [0:0] tmpIO_0__Enc_L_net;
	wire [0:0] tmpINTERRUPT_0__Enc_L_net;
	electrical [0:0] tmpSIOVREF__Enc_L_net;
	...
	cy_psoc3_pins_v1_10
		...
		Enc_L
		 (.oe(tmpOE__Enc_L_net),
		  .y({1'b0}),
		  .fb({Net_911}),
		  .io({tmpIO_0__Enc_L_net[0:0]}),
		  .siovref(tmpSIOVREF__Enc_L_net),
		  .interrupt({tmpINTERRUPT_0__Enc_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Enc_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_4 Encoder_Right (
        .reset(1'b0),
        .tc(Net_1260),
        .comp(Net_1261),
        .clock(Net_1117),
        ...
        .up_ndown(1'b1),
        .count(Net_1249));
    defparam Encoder_Right.CaptureMode = 0;
    defparam Encoder_Right.ClockMode = 0;
    defparam Encoder_Right.CompareMode = 1;
    defparam Encoder_Right.CompareStatusEdgeSense = 1;
    defparam Encoder_Right.EnableMode = 0;
    defparam Encoder_Right.ReloadOnCapture = 0;
    defparam Encoder_Right.ReloadOnCompare = 0;
    defparam Encoder_Right.ReloadOnOverUnder = 0;
    defparam Encoder_Right.ReloadOnReset = 1;
    defparam Encoder_Right.Resolution = 16;
    defparam Encoder_Right.RunMode = 0;
    defparam Encoder_Right.UseInterrupt = 1;

	wire [0:0] tmpOE__Enc_R_net;
	wire [0:0] tmpIO_0__Enc_R_net;
	wire [0:0] tmpINTERRUPT_0__Enc_R_net;
	electrical [0:0] tmpSIOVREF__Enc_R_net;

	cy_psoc3_pins_v1_10
		#(.id("7598541b-5298-4e9b-ae12-3e97f63119ff"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Enc_R
		 (.oe(tmpOE__Enc_R_net),
		  .y({1'b0}),
		  .fb({Net_1249}),
		  .io({tmpIO_0__Enc_R_net[0:0]}),
		  .siovref(tmpSIOVREF__Enc_R_net),
		  .interrupt({tmpINTERRUPT_0__Enc_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Enc_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_5 rightEncTimer (
        .reset(1'b0),
        .tc(Net_1280),
        .comp(Net_1281),
        .clock(Net_1117),
        ...
        .up_ndown(1'b1),
        .count(Net_1162));
    defparam rightEncTimer.CaptureMode = 0;
    defparam rightEncTimer.ClockMode = 0;
    defparam rightEncTimer.CompareMode = 1;
    defparam rightEncTimer.CompareStatusEdgeSense = 1;
    defparam rightEncTimer.EnableMode = 0;
    defparam rightEncTimer.ReloadOnCapture = 0;
    defparam rightEncTimer.ReloadOnCompare = 0;
    defparam rightEncTimer.ReloadOnOverUnder = 0;
    defparam rightEncTimer.ReloadOnReset = 1;
    defparam rightEncTimer.Resolution = 16;
    defparam rightEncTimer.RunMode = 0;
    defparam rightEncTimer.UseInterrupt = 1;

	wire [0:0] tmpOE__three_net;
	wire [0:0] tmpFB_0__three_net;
	wire [0:0] tmpIO_0__three_net;
	wire [0:0] tmpINTERRUPT_0__three_net;
	electrical [0:0] tmpSIOVREF__three_net;
	...
	cy_psoc3_pins_v1_10
		...
		three
		 (.oe(tmpOE__three_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__three_net[0:0]}),
		  .analog({Net_1330}),
		  .io({tmpIO_0__three_net[0:0]}),
		  .siovref(tmpSIOVREF__three_net),
		  .interrupt({tmpINTERRUPT_0__three_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__three_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__four_net;
	wire [0:0] tmpFB_0__four_net;
	wire [0:0] tmpIO_0__four_net;
	wire [0:0] tmpINTERRUPT_0__four_net;
	electrical [0:0] tmpSIOVREF__four_net;
	...
	cy_psoc3_pins_v1_10
		...
		four
		 (.oe(tmpOE__four_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__four_net[0:0]}),
		  .analog({Net_1331}),
		  .io({tmpIO_0__four_net[0:0]}),
		  .siovref(tmpSIOVREF__four_net),
		  .interrupt({tmpINTERRUPT_0__four_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__four_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__five_net;
	wire [0:0] tmpFB_0__five_net;
	wire [0:0] tmpIO_0__five_net;
	wire [0:0] tmpINTERRUPT_0__five_net;
	electrical [0:0] tmpSIOVREF__five_net;

	cy_psoc3_pins_v1_10
		#(.id("c8606549-ac40-439f-bb41-891029f43b32"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		five
		 (.oe(tmpOE__five_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__five_net[0:0]}),
		  .analog({Net_1332}),
		  .io({tmpIO_0__five_net[0:0]}),
		  .siovref(tmpSIOVREF__five_net),
		  .interrupt({tmpINTERRUPT_0__five_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__five_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_1377 = Net_1373 & Net_1374;
