...
extern uint8 TxMessage2[8];
extern uint8 TxMessage3[8];
        ...
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                for(bIndex=0;bIndex<DATALENGTH1;bIndex++){
                    CAN_1_TX_DATA_BYTE(0,bIndex) = TxMessage0[bIndex];
                }
                /* `#END` */
    ...
    uint8 CAN_1_SendMsg1(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                for(bIndex1=0;bIndex1<DATALENGTH1;bIndex1++){
                    CAN_1_TX_DATA_BYTE(1,bIndex1) = TxMessage1[bIndex1];
                }
                /* `#END` */
    ...
    uint8 CAN_1_SendMsg2(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                for(bIndex1=0;bIndex1<DATALENGTH1;bIndex1++){
                    CAN_1_TX_DATA_BYTE(2,bIndex1) = TxMessage2[bIndex1];
                }
                /* `#END` */
    ...
    uint8 CAN_1_SendMsg3(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                for(bIndex1=0;bIndex1<DATALENGTH1;bIndex1++){
                    CAN_1_TX_DATA_BYTE(3,bIndex1) = TxMessage3[bIndex1];
                }
                /* `#END` */
